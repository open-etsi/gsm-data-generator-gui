...
wget -c https://github.com/open-etsi/gsm-data-generator/archive/refs/tags/gsm_data_generator_v${version_rc}.zip
wget -c https://github.com/open-etsi/gsm-data-generator/archive/refs/tags/gsm_data_generator_v${version_rc}.tar.gz
...
diff github/md5sum.txt ./github/md5sum.txt
...
echo "[6/9] Unzip "gsm_data_generator_v${version_rc}.tar.gz" ..."
tar -zxf gsm_data_generator_v${version_rc}.tar.gz
